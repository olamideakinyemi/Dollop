    ...
    <div>
      ...
      <div className="mx-48 grid grid-cols-2">
        <div className="-mt-24">
          ...
          <div className=" shadow-lg rounded-3xl w-auto h-32">
            <div className="flex mt-8">
              <img
                className="mx-4 w-6 mt-8"
          ...
          <div className="my-6 shadow-lg rounded-3xl w-auto h-32">
            <div className="flex mt-8">
              <img
                className="mx-4 w-6 mt-8"
                src="/img/checkmark.png"
          ...
          <Link href="/">
              <a className="py-3 px-6 border-solid border border-green duration-300 rounded  text-sm text-white bg-green hover:bg-green">
                Subscribe Now
              </a>
            </Link>
          </div>
      ...
      <div className="mx-48 grid grid-cols-2">
        ...
        <div>
          <h1 className="font-bold text-2xl">
            What we have done with your donations
          </h1>
          ...
          <div className="flex mt-6">
            <div className="">
              ...
              <p className="font-semibold text-lg mt-2 border-b-2 border-red w-5">
                $300,000
              </p>
            </div>
            <div className="ml-40">
              <p className="text-xs">Countries reached</p>
              <p className="font-semibold text-lg mt-2  border-b-2 border-yellow w-5">
                25
              </p>
            </div>
          </div>
          <div className="mt-16">
            ...
            <p className="font-semibold text-lg mt-2  border-b-2 border-green w-5">
              5000
            </p>
          </div>
      ...
      <div className="mt-40">
        ...
        <div className="flex ml-56 mt-12">
          <img
            className="w-20 h-auto ml-24"
            src="/img/speakupafrica.png"
            alt="/"
          />
          <img
            className="w-20 h-auto ml-24"
            src="/img/globalgiving.png"
            alt="/"
          />
          <img className="w-20 h-auto ml-24" src="/img/gofundme.png" alt="/" />
          <img
            className="w-20 h-auto ml-24"
            src="/img/helpinghandsfund.png"
            alt="/"
          />
        </div>
      </div>
